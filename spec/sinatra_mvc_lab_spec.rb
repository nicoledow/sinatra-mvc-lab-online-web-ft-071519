describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize' again" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("eHay asway anway oldway anmay howay ishedfay aloneway inway away iffskay inway ethay ulfGay eamStray andway ehay adhay onegay eightyway ourfay aysday ownay ithoutway akingtay away ishfay")
    end
  end
